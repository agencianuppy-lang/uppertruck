            ...
            <div class="user-dashboard">
               <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12 gutter">
                     <div class="sales">
                        <h3 class="titulo-geral">AGENDAMENTO</h3>
                        <br>  
                        <div class="abrange2">
                          <form method="post" id="FormAgendamento">
                             <div class="col-md-3">  
                                <label style="color: #00134b;">Titulo</label>
                                <input maxlength="50" id="titulo" name="titulo" class="form-control" type="text">
                             </div>

                             <div class="col-md-3">  
                                <label style="color: #00134b;" for="">Data</label>
                                <input id="data" name="data" class="form-control" type="date">
                             </div>

                             <div class="col-md-2">
                                <label style="color: #00134b;" for="">Horário</label>
                                <div class="form-inline required">
                                   <div style="padding-right: 9px;padding-left: 0px;" class="form-group has-feedback col-xs-6">
                                      <label class="input-group">
                                         <span class="input-group-addon">
                                         <input onClick="MostraCampo()" type="radio" name="hora" value="0" />
                                         </span>
                                         <div onClick="MostraCampo()" class="form-control form-control-static">
                                            SIM
                                         </div>
                                         <span class="glyphicon form-control-feedback"></span>
                                      </label>
                                   </div>
                                   <div style="padding-right: 9px;" class="form-group has-feedback col-xs-6">
                                      <label class="input-group">
                                         <span class="input-group-addon">
                                          <input selected onClick="OcultaCampo()" type="radio" name="hora" value="1" />
                                         </span>
                                         <div onClick="OcultaCampo()" class="form-control form-control-static">
                                            NÃO
                                         </div>
                                         <span class="glyphicon form-control-feedback "></span>
                                      </label>
                             ...
                             <div class="col-md-12">
                              ...
                              <div style="display:none" id="divHorario" class="col-md-2">
                                 <label style="color: #00134b;" for="">Horário</label>
                                 <input class="form-control" id="horario" name="horario" type="time">
                              </div>
                             ...
                             <div style="padding: 0px;" class="col-md-12">
                                ...
                                <textarea class="descricao" name="descricao" id="editor1"></textarea>
                                <br>
                                <div style="padding: 0px;" class="pull-right col-md-2"> 
                                   <button id="btnAgendamento" type="button" style="width: 100%;padding: 3% 0%;background: #4CAF50;" class="btn btn-primary">Agendar</button>
                                </div>
                             </div>
                          </form>
                        </div>
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12 gutter">
                     <div class="sales">
                        <div style="width: 100%" class="abrange2 corpo">
                          ...
                          <?php
                            $agendamentos = $class->Select("*", "agenda", "ORDER BY id DESC", "LIMIT 4");
