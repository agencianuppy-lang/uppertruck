...
<html lang="pt-br">
               ...
               <div class="user-dashboard">
                  <div class="row">
                     <div class="col-md-12 col-sm-12 col-xs-12 gutter">
                        <div class="sales">
                           <h3 class="titulo-geral">EDITAR ARTIGO 
                           ...
                           <div style="padding-left: 0px;" class="col-md-4">
                              <a href="https://<?= $server ?>/detalhe-artigo-adm/<?= $_GET['artigo'] ?>">
                                 <div style="padding-left: 0px;" class="col-md-12">
                                    <div class="tamanho-fo-bag">
                                       <div style="margin-top: 0px;    max-height: 185px;    width: 100%;" class="moldura-album" type="">
                                          <img style="    max-height: 185px" width="100%" class="foto-galeriax" src="https://<?= $server ?>/admin/_artigos/<?= $rowN->img ?>" alt="">
                                       </div>
                           ...
                           <div class="abrange2 corpo">
                              <form enctype="multipart/form-data" id="FormAttNot" style="width: 100%">
                                 ...
                                 <div class="col-md-4">
                                    ...
                                    <input maxlength="100" value="<?= $rowN->titulo ?>" name="att-titulo" class="form-control" type="text">
                                 </div>
                                 <div class="col-md-4">
                                 ...
                                 <div class="col-md-12">
                                    ...
                                    <div style="padding: 0px; margin-top: 1%;    margin-right: 9px" class="pull-right col-xs-3">
                                       <button type="button" onClick="deletaNoticia(<?= $rowN->id ?>)" style="width: 100%;background: #F44336;" class="btn btn-primary">Excluir Artigo</button>
                                    </div>
                                 </div>
                              </form>
                           </div>
                     ...
                     <div class="col-md-12 col-sm-12 col-xs-12 gutter">
                        <div class="sales">
                           <div class="abrange2">
                              ...
                              <?php 
                                 // Busca noticias
                                 $not = $class->Select("*", "artigos", "ORDER BY hora_postagem DESC", " LIMIT 6");
                                 while($row = $not->fetch(PDO::FETCH_OBJ)){
                                    ...
                                    ($tam > 59) ? $rets = "..." : $rets = "";
                              ?>
                              <a href="https://<?= $server ?>/detalhe-artigo-adm/<?= $row->id ?>">
                                 <div class="col-xs-2">
                                    <div class="btn btn-default moldura-album" type="">
                                       <img width="100%" class="foto-galeriax" src="https://<?= $server ?>/admin/_artigos/<?= $row->img ?>" alt="">
                                    </div>
   ...
   <script type="text/javascript" src="https://<?= $server ?>/admin/_artigos/js/main.js"></script>
   </head>
   <script>
