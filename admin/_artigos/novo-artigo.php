               ...
               <div class="user-dashboard">
                  <div class="row">
                     <div class="col-md-12 col-sm-12 col-xs-12 gutter">
                        <div class="sales">
                           <h3 class="titulo-geral">PUBLICAR ARTIGOS
                           ...
                           <div class="abrange2 corpo">
                            <form enctype="multipart/form-data" id="formNot" style="width: 100%">
                              <div class="col-md-4">
                                 <label style="color:#001246" for="">Titulo do artigo</label>
                                 <input maxlength="100" name="not-titulo" class="form-control tituloNot" type="text">
                              </div>
                              <div class="col-md-4 contIMG">
                                 <label style="color:#001246" for="">Imagem  do artigo</label>
                     ...
                     <div class="col-md-12 col-sm-12 col-xs-12 gutter">
                        <div class="sales">
                           <div class="abrange2">
                              <h3 class="titulo-geral">ÚLTIMOS ARTIGOS </h3>
