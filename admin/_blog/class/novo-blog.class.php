<?php
	...
	if ($_POST){
		...
		$sql = $pdo->prepare("INSERT INTO blog (title, titulo, artigo, hora_postagem, categoria, slug, keywords, description) VALUES ('$title', '$titulo', '$descricao', '$hora_postagem', '$categoria', '$slug', '$keywords', '$description')");
		$sql->execute();
		$id = $pdo->lastInsertId();
