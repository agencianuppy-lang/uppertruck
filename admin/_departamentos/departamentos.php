               ...
               <div class="user-dashboard">
                  <div class="row">
                     <div class="col-md-12 col-sm-12 col-xs-12 gutter">
                        <div class="sales">
                           <h3 class="titulo-geral">DEPARTAMENTOS
                           ...
                           <div class="abrange2 corpo">
                              <form id="formDepto">
                                 ...
                                 <div style="padding-left: 0px;" class="col-md-4 contIMG">
                                 ...
                                 <div style="padding: 0px;margin-top:1%;" class="col-md-12">
                                    ...
                                    <div style="padding: 0px;" class="pull-right col-md-2"> 
                                       <button id="btnDepto" type="button" style="width: 100%;padding: 3% 0%;background: #4CAF50;" class="btn btn-primary">Publicar</button>
                                    </div>
                                 </div>
                              </form>
                           </div>
