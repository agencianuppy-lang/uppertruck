               ...
               <div class="user-dashboard">
                  <div class="row">
                     <div class="col-md-12 col-sm-12 col-xs-12 gutter">
                        ...
                        <div class="sales">
                          <form id="editAlb">
                            <input type="hidden" name="idAlb" value="<?= $_GET['album']; ?>">
                             <h3 class="titulo-geral">EDITAR ALBUM 
                             ...
                             <div class="abrange2 corpo">
                                ...
                                <input maxlength="100" id="attNome" value="<?= $rowA->titulo ?>" name="att-nome" class="form-control inpAlbum" type="text">
                                
                                <br>

                                <label style="color:#001246" for="">Data do album</label>
                                <input id="attData" value="<?= $rowA->data ?>" name="att-data" class="form-control inpAlbum" type="date">

                                <div style="padding: 0px; margin-top: 5%" class="col-xs-6">
                                   <a href="https://<?= $server ?>/album/<?= $_GET['album'] ?>">
                                ...
                                <div style="padding: 0px; margin-top: 5%" class="col-xs-6">
                                   <button id="btAtt" type="button" style="width: 100%; background-color: #449d44;" class="btn btn-success">
                                    Salvar
                                   </button>
                                </div>
                             </div>
                     ...
                     <div class="col-md-12 col-sm-12 col-xs-12 gutter">
                        <div class="sales">
                           <h3 class="titulo-geral"><b><?= $rowA->titulo ?> <br><small style="color: #7b7b7b; font-weight: bold;letter-spacing: 1.1px;"><?= $gal->FormataData($rowA->data) ?></small></b></h3>
