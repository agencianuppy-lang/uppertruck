               ...
               <div class="user-dashboard">
                  <div class="row">
                     <div class="col-md-12 col-sm-12 col-xs-12 gutter">
                        <div class="sales">
                           <div class="abrange2">
                              <h3 class="titulo-geral">GALERIA DE FOTOS</h3>
                              <div class="col-md-2">
                                 <a href="https://<?= $server ?>/novo-album">
                                    <buttom class="btn btn-default moldura-album" type="">
                                       <img width="100%" class="foto-galeriax" src="https://<?= $server ?>/admin/img/mais.jpg" alt="">
                                    </buttom>
                                    <h4 class="titulo-album" for="">Criar album</h4>
                                 </a>
                              </div>
                              ...
                              <div  class="col-md-2">
                                 ...
                                 <h4 class="titulo-album" for=""><?= $row->titulo ?> <br> 
