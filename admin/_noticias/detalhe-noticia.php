               ...
               <div class="user-dashboard">
                  <div class="row">
                     <div class="col-md-12 col-sm-12 col-xs-12 gutter">
                        <div class="sales">
                           <h3 class="titulo-geral">EDITAR NOTÍCIA 
                           ...
                           <div style="padding-left: 0px;" class="col-md-4">
                              <a href="https://<?= $server ?>/detalhe-noticia-adm/<?= $_GET['noticia'] ?>">
                                 <div style="padding-left: 0px;" class="col-md-12">
                                    <div class="tamanho-fo-bag">
                                       <div style="margin-top: 0px;    max-height: 185px;    width: 100%;" class="moldura-album" type="">
                                          <img style="    max-height: 185px" width="100%" class="foto-galeriax" src="https://<?= $server ?>/admin/_noticias/<?= $rowN->img ?>" alt="">
                                       </div>
                           ...
                           <div class="abrange2 corpo">
                              <form enctype="multipart/form-data" id="FormAttNot" style="width: 100%">
                                 ...
                                 <div class="col-md-8">
                                    ...
                                    <textarea class="descricao" id="editor1" name="att-descricao"><?= $rowN->noticia ?></textarea>                                 
                                 </div>
                                 <div class="col-md-12">
                                    ...
                                    <div style="padding: 0px; margin-top: 1%;    margin-right: 9px" class="pull-right col-xs-3">
                                       <button type="button" onClick="deletaNoticia(<?= $rowN->id ?>)" style="width: 100%;background: #F44336;" class="btn btn-primary">Excluir Notícia</button>
                                    </div>
                                 </div>
                              </form>
                           </div>
                           ...
                           <div class="abrange2">
                              ...
                              <a href="https://<?= $server ?>/detalhe-noticia-adm/<?= $row->id ?>">
                                 <div class="col-xs-2">
                                    ...
                                    <label><?= substr($row->noticia, 0, 59).$rets ?></label>
                                 </div>
                              </a>
                              <?php
                                 }
