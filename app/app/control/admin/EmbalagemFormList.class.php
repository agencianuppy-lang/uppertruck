<?php
class EmbalagemFormList extends TPage
{
 ...
 protected $form;      // form
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('Embalagem'); // define the Active Record
        $this->setDefaultOrder('id', 'asc'); // define the default order
        $this->setLimit(-1); // turn off limit for datagrid
        
        // create the form
        $this->form = new BootstrapFormBuilder('form_embalagem');
        $this->form->setFormTitle('Embalagens - cadastro');
        ...
        $col_nome  = new TDataGridColumn('nome', 'Descrição', 'left', '90%');
