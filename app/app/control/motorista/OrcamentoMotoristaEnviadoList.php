<?php
class OrcamentoMotoristaEnviadoList extends TStandardList
{
    ...
    public function __construct()
    {
        ...
        $criteria->add( new TFilter( 'status', '=', '2'  ) ); // Enviado pelo motorista e pendente de análise pela uppertruck
        ...
        {
            $msg = new TTextDisplay('Sem orçamento em análise', 'black', 12, 'bi');
            $vbox->add($msg);
        }
