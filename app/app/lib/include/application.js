...
//id=tbutton_btn_veículos
//class=iquedev-display-none
function showBtnVeiculos(show = true)
{
    const btn = document.getElementById('tbutton_btn_veículos');
    if (btn.classList.contains("iquedev-display-none") )
        btn.classList.remove('iquedev-display-none');
   
}
function hideBtnVeiculos(show = true)
{
    const btn = document.getElementById('tbutton_btn_veículos');
    if (!btn.classList.contains("iquedev-display-none") )
            btn.classList.add('iquedev-display-none');
}
