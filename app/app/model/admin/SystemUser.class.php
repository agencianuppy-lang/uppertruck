...
class SystemUser extends TRecord
{
    ...
    public function __construct($id = NULL)
    {
        ...
        parent::addAttribute('nick_name');
        parent::addAttribute('type');
        parent::addAttribute('cpf_cnpj');
        parent::addAttribute('cod_state');
        parent::addAttribute('cod_city');
        ...
        parent::addAttribute('user_responsible_id');
        parent::addAttribute('normalizado');    
        parent::addAttribute('hystoric_data');         
    }
