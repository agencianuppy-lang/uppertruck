<section class="section-shell final-cta" id="contato-final">
    <video class="final-cta-video" autoplay muted loop playsinline preload="metadata" aria-hidden="true">
        <source src="/uppertruck/img/trucks321.mp4" type="video/mp4">
    </video>
