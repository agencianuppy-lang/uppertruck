...
<section class="section-shell solutions" id="solucoes">
    <div class="container">
        <div class="section-head reveal">
            ...
            <h2>Arquitetura de transporte para operações recorrentes e sob demanda</h2>
            <p>Estrutura modular para distribuir melhor, reduzir fricção operacional e manter nível de serviço em escala.</p>
        </div>

        <div class="solutions-layout">
            <article class="solution-feature reveal">
                <span class="solution-chip">Solução destaque</span>
